export default {
  'pages.layouts.userLayout.title': '一站式信息存储，可满足您所有的学习资源和相关需求',
  ...
  'pages.welcome.search.keywords': '热门搜索类别',
  'pages.welcome.alertMessage': '欢迎来到StudyMama！您的一站式商店可为您的学习需求提供更快，更相关的搜索结果。',
  'pages.welcome.search.category': '输入搜索类别',
